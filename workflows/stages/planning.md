---
name: planning
description: Produces the phase plan — planner creates from brief, grounding, ideation, and the phase list phase 1 fixed; validator renders the verdict; a capped revise loop converges; the blocking plan-approval gate collects the human decision. Every plan declares its file scope, the contract implementation loops bind to.
---
